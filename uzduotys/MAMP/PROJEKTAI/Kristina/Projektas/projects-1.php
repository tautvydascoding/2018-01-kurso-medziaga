            ...
            <div class="row projektai">
                ...
                <div class="col-6 proj-col-2 col-lg-6 col-md-6 col-xs-6 d-flex justify-content-center ">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item active">
                            ...
                            <img class="d-block w-70" src="./img/sakura-no-emi/1.jpg">
                        </div>
                        <div class="carousel-item">
                            <div class="numbertext2">2 / 9</div>
                            <img class="d-block w-70" src="./img/sakura-no-emi/2.jpg">
                        </div>
                        <div class="carousel-item">
                            <div class="numbertext2">3 / 9</div>
                            <img class="d-block w-70" src="./img/sakura-no-emi/3.jpg">
                        </div>
                        <div class="carousel-item">
                            <div class="numbertext2">4 / 9</div>
                            <img class="d-block w-70" src="./img/sakura-no-emi/4.jpg">
                        </div>
                        <div class="carousel-item">
                            <div class="numbertext2">5 / 9</div>
                            <img class="d-block w-70" src="./img/sakura-no-emi/5.jpg">
                        </div>
                        <div class="carousel-item">
                            <div class="numbertext2">6 / 9</div>
                            <img class="d-block w-70" src="./img/sakura-no-emi/6.jpg">
                        </div>
                        <div class="carousel-item">
                            <div class="numbertext2">7 / 9</div>
                            <img class="d-block w-70" src="./img/sakura-no-emi/7.jpg">
                        </div>
                        <div class="carousel-item">
                            <div class="numbertext2">8 / 9</div>
                            <img class="d-block w-70" src="./img/sakura-no-emi/8.jpg">
                        </div>
                        <div class="carousel-item">
                            <div class="numbertext2">9 / 9</div>
                            <img class="d-block w-70" src="./img/sakura-no-emi/9.jpg">
                        </div>
                ...
                <div class="col-6 proj-col-2 pt-10 col-lg-6 col-md-6 col-xs-6">
                    <div class="proj-names-fonas">
                        <h4 class="proj-names-2"><i>SAKURA NO EMI</i></h4> 
                        <p class="proj-names-cont">Manga skirta Silent Manga Audition konkursui (konkurso tema - "Sakura, keep on smiling"). <br> Istorija pasakoja apie mažą mergaitę, kuri atsidėkodama medžiui už pavasarį suteigtą žydėjimo grožį, ištisus metus kiekvieną dieną jį aplanko ir atneša iš popieriaus iškirptą žiedelį, taip tikėdamasi, kad žmonės vėl sugrįš ir džiaugsis medžio grožiu.</p>
                    </div>
