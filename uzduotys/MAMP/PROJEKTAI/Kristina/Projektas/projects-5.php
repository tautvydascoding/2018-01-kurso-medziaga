            ...
            <div class="row projektai">
                ...
                <div class="col-6 proj-col-2 col-lg-6 col-md-6 col-xs-6 d-flex justify-content-center ">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item active">
                            ...
                            <img class="d-block w-70" src="./img/tatatako/1.jpg">
                        </div>
                        <div class="carousel-item">
                            <div class="numbertext2">2 / 2</div>
                            <img class="d-block w-70" src="./img/tatatako/2.jpg">
                        </div>
                ...
                <div class="col-6 proj-col-2 pt-10 col-lg-6 col-md-6 col-xs-6">
                    <div class="proj-names-fonas">
                        <h4 class="proj-names-2"><i>TaTaTAKO</i></h4> 
                        <p class="proj-names-cont">Manga skirta Silent Manga Audition konkursui (konkurso tema - "Fair play").<br> Istorija pasakoja apie aštuonkojį, kuris vardan sąžiningo žaidimo, dalyvaudamas bėgimo varžybose nesinaudoja savo pranašumu - 8-nių kojų turėjimu.</p>
                    </div>
