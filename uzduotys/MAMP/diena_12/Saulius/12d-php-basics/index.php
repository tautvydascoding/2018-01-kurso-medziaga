...
echo "labas" . $vardas . "viso <br>"; // "labas Povilas viso"

//local
$vardas = "Tomas";
function manoFunkcija($x) { // $x - (local) naujas issigalvotas laikinas kintamasis
echo "1. x pries pakeiciant:" . $x . "<br>";
    $x = "Karolis Didysis";
}
manoFunkcija($vardas);
echo $vardas . "<br>";
//karolisdidysis dingsta nes $x yra localus varas del to jo neissaugojus kintamajame jo reiksme po funkcijos dingsta


// return
function getManoFunkcija($x) { // $x - (local) naujas issigalvotas laikinas kintamasis
...
echo $naujas . "<br>";
// cia su returnu ir nauju varu local varo reiksme issaugoma
...
//constant
define("USERNAME", "Kazys");
define("SLAPTAZODIS", "blablabla");
