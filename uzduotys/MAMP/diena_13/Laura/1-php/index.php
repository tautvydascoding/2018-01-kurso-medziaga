...
// print_r($meniu);                      //pasitestuojam ar veikia
...
$manoFoto = ["1.jpg", "2.jpg", "3.jpg", "4.jpeg"];
//print_r($manoFoto);           //pasitestinti ar veikia foto;

// C. atspausdinti visas nuotraukas su ciklu, po 3-ris i eilute

// <img src='./img/1.jpg' alt='la'  />


for ($i=0; $i < count($manoFoto) ; $i++) {
    /// pasitestuoju ar veikia
    //echo "<img src='./img/2.jpg' alt='la'/>";
...
/// SPRENDIMAI//
//1. sukurti matrica, kurioje bus saugoma kiekvienos prekes info.
// Antraste, img pavadinimas, prekes aprasymas, kaina.
$prekes = [];
$prekes[0] = ["Dviratis", "1.jpg", 99.99, "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."];
$prekes[1] = ["Paspirtukas", "2.jpg", 200.99, "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."];
$prekes[2] = ["Rieduciai", "3.jpg", 300.99, "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."];
$prekes[3] = ["Slides", "4.jpeg", 50.99, "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."];
...
<!--
 //arba
    // $vardas = $prekes[$i][0]. "<br />";
    // echo "$vardas". "<br />";
    // $kaina = $prekes[$i][2]. "<br />";
    // echo "$kaina". "<br />"; -->

<!-- // arba  echo $prekes[$i][0]. "<br>";
