...
<html>
    ...
    <body>
        ...
        <div class="container">
            <h1 class="d-flex justify-content-center align-items-center">GYDYTOJAI</h1> 

            <?php
            include('./libs/doctors-db.php');
            ...
            <article class="row d-flex justify-content-center align-items-center">
                    <?php $gydytojas = getDoctor($i); //masyvas ?>
        ...
        <?php } ?>  <!-- visa kartos iki ciklo pabaigos } -->
