...
<?php if ($_GET['rodytiforma'] == true) : ?> 

        <form class="<?php echo "bg-info m-5" ?>" action="create_doctor.php" method="get">
            <input type="text" name="vardas" value="" placeholder="Vardas">
            <input type="text" name="pavarde" value="" placeholder="Pavarde">

            <!-- !!! button type yra "submit" kitaip neveiks  -->
            <button type="submit" name="button">  Sukurti </button>
        </form>
<?
endif;
?>
