...
try {
    ...
    $mail->Username = 'elvizz29test@gmail.com';                 // SMTP username
    $mail->Password = 'programeris2018';                           // SMTP password
    //Recipients
    $mail->setFrom('elvizz29test@gmail.com', 'Puslapiu kurejai');
    $mail->addAddress('elvizz29test@gmail.com', 'Joe User');     // Add a recipient
