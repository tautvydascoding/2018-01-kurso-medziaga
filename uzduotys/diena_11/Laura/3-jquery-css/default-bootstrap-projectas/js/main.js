...
//I UZDUOTIS
//A) visus h1 ir h2 pakeisti i melynus;
$( "h1, h2" ).css( "color", "blue" );

// B) paskutinta list elemeneta i zalia;
...
// !!! important sekantis parametras nurodo kur ieskoti. pvz ^ h1 bus ieskomas TIK form'os viduje !!!
...
//$("h2").siblings().css({"color": "red", "border": "2px solid red"}); ///siblings zodis tik broli ir sese suranda.
...
//$("h2").nextUntil("h6"); //iki ko ieskoti

$('h2').nextUntil('.noname'). css("color", "green"); ///!! tik su elementais, su klasem neveiks.
