...
// $('h1').text( tekstas + " <strong> Pakeistas </strong>"); //tagai neveiks - bus isvesti
$('h1').html( tekstas + " <strong> Pakeistas </strong>");



var a = $('h1')[0];   // DOM elementas
var b = $('h1').eq(0);   ///jq Objektas
var c = $('h1');

console.log(a, b, c);

// a.css("background-color", "yellow");   //ERROR - neveikia nes tai DOM elementas
