// visus h1 ir h2 color = blue,
// paskutini li elementa pakeisti i zalia

    $("h1, h2").css("color", "blue");


    $("li:not(#spec)").css("color", "yellow");
    //veikia abu
    ...
    // tik su elementais o su class neveiks
    $("h2").nextUntil(".noname").css("color", "orange");
