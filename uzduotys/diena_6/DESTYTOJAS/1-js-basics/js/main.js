...
function printVardasPavardeAmzius() {
 ...
 printVardasPavardeAmzius();  // liepiat kompiuteriui surasti tokia f-ja ir ja ivykdyti
 printVardasPavardeAmzius();  // liepiat kompiuteriui surasti tokia f-ja ir ja ivykdyti
 printVardasPavardeAmzius();  // liepiat kompiuteriui surasti tokia f-ja ir ja ivykdyti
 printVardasPavardeAmzius();  // liepiat kompiuteriui surasti tokia f-ja ir ja ivykdyti
var x = 100 / 5 + 15;
...
function printAddressData() {
    console.log("Aderesas: ", salis, miestas, adresas, pastoKodas);
}
printAddressData();
// ---- advance-----
